              ...
              Row(
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text('Abdul Aziz  ',style: kHeading6.copyWith(color: kMatterhornBlack),
                    )
                  ],
                ),
                Container(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16,),
                    Text('Rp. 10.430.000 / 40.000.000', style: kCaption.copyWith(color: kWhite),)
                  ],
                ),
  ...
  Widget _transactionButton(String icon, String text){
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(color: kNightBlack,
